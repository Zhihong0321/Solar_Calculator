SOFT-REMOVE(2026-04-21): moved out of active docs because this guide defaulted to legacy `package_id` invoice links and a Python/uvicorn localhost flow that do not reflect the current invoicing app.
