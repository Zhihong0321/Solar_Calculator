...
- TAKE USER INSTRUCTIONS AS ABSOLUTE COMMANDS.
- NO GUESSING. DO EXACTLY WHAT IS ASKED AND NOTHING MORE.
- IF A REFERENCE FILE IS PROVIDED, USE IT EXACTLY AS PROVIDED WITHOUT REDESIGNING.
