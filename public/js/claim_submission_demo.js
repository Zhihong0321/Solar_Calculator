(function () {
  ...
  function processItem(id) {
    ...
    return fetch("/demo/api/claim-receipts/ocr", { method: "POST", body: body })
  ...
  function createClaim(id) {
    ...
    return fetch("/demo/api/claim-receipts", {
      method: "POST",
  ...
  function saveEdits(id) {
    ...
    item.stage = "saving";
    renderCard(item);
    fetch("/demo/api/claim-receipts/" + item.claimId, {
      method: "PUT",
      headers: { "Content-Type": "application/json" },
  ...
  function deleteClaim(id) {
    var item = findItem(id);
    if (!item) return;
    var request = item.claimId ? fetch("/demo/api/claim-receipts/" + item.claimId, { method: "DELETE" }) : Promise.resolve();
  ...
  function loadMyClaims() {
    ...
    fetch("/demo/api/claim-receipts/mine", { credentials: "same-origin" })
      .then(function (res) {
  ...
  window.deleteClaim = function (claimId) {
    ...
    fetch("/demo/api/claim-receipts/" + claimId, {
      method: "DELETE",
