(() => {
    ...
    function createMarkup({ title, subtitle, applyLabel, skipLabel, showHeader }) {
        return `
            <div class="rounded-2xl border border-slate-200 bg-white shadow-sm">
                ...
                ` : ''}
                <div data-voucher-loading class="px-5 py-10 text-sm text-slate-500">Loading voucher groups...</div>
                <div data-voucher-error class="hidden px-5 py-10">
                    <p data-voucher-error-text class="text-sm font-medium text-red-600"></p>
                </div>
                <div data-voucher-empty class="hidden px-5 py-10 text-sm text-slate-500">
                    No active voucher groups are available for this quotation.
                </div>
                <div data-voucher-category-list class="hidden space-y-4 px-5 py-5"></div>
        ...
        function renderCategories(categories) {
            ...
            categories.forEach((category) => {
                ...
                category.vouchers.forEach((voucher) => {
                    ...
                    const item = { checkbox, wrapper, titleEl, codeEl };
