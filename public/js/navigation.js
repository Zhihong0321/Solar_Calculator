(() => {
    ...
    const ROUTES = [
        ...
        },
        {
            ...
            parentPage: 'agent-home',
            toolGroup: 'Workspace',
            toolLabel: 'Company Cloud',
            toolDescription: 'Access shared resources & folders',
            icon: 'cloud'
        },
        {
            pageKey: 'qr-generator',
            path: '/qr-generator',
            title: 'WhatsApp QR',
            rootTab: TOOLS_ROOT_KEY,
            routeType: 'tool',
            ...
            parentPage: 'agent-home',
            toolGroup: 'Workspace',
            toolLabel: 'WhatsApp QR',
            toolDescription: 'wa.me QR code generator',
            icon: 'qr'
        },
        {
