...
const IMAGE_OR_VIDEO = ['image/*', 'video/*'];
const IMAGE_PDF_OR_VIDEO = ['image/*', 'application/pdf', 'video/*'];
const VIDEO_OR_IMAGE = ['video/*', 'image/*'];
...
const DOC_TYPES = {
    ...
    site_video: {
        category: 'site_assessment',
        label: 'Site Video',
        hint: 'Video walkthrough or recording of the site and roof.',
        accept: VIDEO_OR_IMAGE,
        maxMB: 100,
        multi: true,
        required: false,
        order: 8,
