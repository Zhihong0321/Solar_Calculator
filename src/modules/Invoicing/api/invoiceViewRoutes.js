...
const EV_CHARGER_PACKAGE_IDS = new Set([
  ...
  'pkg_ev_11kw_3p_charger_only_20260713',
  'pkg_ev_installation_1p_20260713',
  'pkg_ev_installation_3p_20260713'
]);
...
function buildPublicEnergyFlow(details = {}) {
  ...
  const batteryDischargeKwh = Number(details?.battery?.monthlyStoredKwh) || 0;
  const backupGenerationKwh = Number(details.backupGenerationKwh) || 0;
